...
create table sensors(		sensor_id integer NOT NULL AUTO_INCREMENT, ip varchar(15) not null, active boolean not null, start DATETIME not null, end DATETIME, description varchar(50), primary key(sensor_id)) engine = InnoDB;
